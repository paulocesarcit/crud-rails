...
class CrudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crud" do
    assert_difference('Crud.count') do
      post cruds_url, params: { crud: { email: @crud.email, id_seq: @crud.id_seq, nome: @crud.nome } }
    end
  ...
  test "should update crud" do
    patch crud_url(@crud), params: { crud: { email: @crud.email, id_seq: @crud.id_seq, nome: @crud.nome } }
